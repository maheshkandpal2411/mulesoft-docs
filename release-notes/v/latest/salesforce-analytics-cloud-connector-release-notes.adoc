...
Release notes for version 2.2.0 of the Salesforce Analytics Cloud connector. These release notes accompany the
...
+
The authentication configuration now allows the user to disable session invalidation by checking the Disable session invalidation checkbox.
